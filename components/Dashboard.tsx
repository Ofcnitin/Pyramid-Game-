  ...
  useEffect(() => {
    async function loadDashboard() {
      ...
      const { data: membership, error: membershipError } = await supabase
        .from('game_players')
        .select(
          'id,game_id,user_id,current_rank,previous_rank,points,joined_at'
        )
        .eq('user_id', user.id)
      ...
      if (membershipError) {
        setError('Unable to load your game membership.');
        setLoading(false);
        return;
      }
    ...
    <AppShell>
      ...
      {!game || !player ? (
        ...
        >
          ...
          <p className="sub">
            Create a private game or join an existing
            room to see your real ranking and game
            statistics here.
          </p>
        ...
        <>
          <div className="grid2">
            ...
            <div className="card quote">
              <p>
                “People show you who they are, you just
                rank them.”
              </p>
          ...
          >
            ...
            <p className="sub">
              Your statistics above are loaded from
              the current private game rather than demo
              data.
            </p>
          </div>
        </>
