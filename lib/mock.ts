...
export const game:Game={id:'g1',name:'Friday Night Pyramid',code:'PYR-8K4M2', passwordProtected: true ,status:'voting',round:3,totalRounds:6,maxPlayers:16,votesPerPlayer:3,durationSeconds:756};
