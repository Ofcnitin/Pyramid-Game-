...
export default function PyramidPage() {
  ...
  async function loadPyramid() {
    ...
    try {
      ...
      //
      // During voting, this intentionally shows the previous
      // completed Pyramid instead of exposing an unfinished
      // grade calculation.
      const {
        data: roundData,
        error: roundError,
      ...
      // Load rankings generated by the secure database function.
      const {
        data: rankingData,
        error: rankingError,
      } = await supabase
      ...
      // Profiles contain only public display information.
      const {
        data: profileData,
        error: profileError,
      } = await supabase
      ...
      const result: PyramidPlayer[] = rankings
        .map((ranking) => {
        ...
        .filter(
          (player): player is PyramidPlayer =>
            player !== null
        );
    ...
    <AppShell>
      ...
      {loading ? (
        ...
        <div className="card pyramid-page-state">
          ...
          <p>
            Once a round is completed, the system will
            compare the voting distribution and
